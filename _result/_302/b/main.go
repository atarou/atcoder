	...
	for i := 0; i < h; i++ {
		for j := 0; j < w; j++ {
			...
			for k := 0; k < 8; k++ {
				...
				j4 := j + 3*dy[k]
				j5 := j + 4*dy[k]
				if i5 > h-1 || i5 < 0 || j5 > w-1 || j5 < 0 {
					continue
				}
				if sss[i1][j1] == "s" && sss[i2][j2] == "n" && sss[i3][j3] == "u" && sss[i4][j4] == "k" && sss[i5][j5] == "e" {
					i1++
					j1++
					i2++
					j2++
			...
			// if j+4 <= w-1 {
			// 	if sss[i][j] == "s" && sss[i][j+1] == "n" && sss[i][j+2] == "u" && sss[i][j+3] == "k" && sss[i][j+4] == "e" {
			// 		i++
			// 		j++
			// 		out(i, j)
			// 		out(i, j+1)
			...
			// }
			// if i+4 <= h-1 {
			// 	if sss[i][j] == "s" && sss[i+1][j] == "n" && sss[i+2][j] == "u" && sss[i+3][j] == "k" && sss[i+4][j] == "e" {
			// 		i++
			// 		j++
			// 		out(i, j)
			// 		out(i+1, j)
			...
			// }
			// if i+4 <= h-1 && j+4 <= w-1 {
			// 	if sss[i][j] == "s" && sss[i+1][j+1] == "n" && sss[i+2][j+2] == "u" && sss[i+3][j+3] == "k" && sss[i+4][j+4] == "e" {
			// 		i++
			// 		j++
			// 		out(i, j)
			// 		out(i+1, j+1)
